...
* [CoinPing](https://github.com/SeigeC/coinping-bot) - Multi-condition crypto price alerts (thresholds, 24h change, exchange spreads). Go + CoinGecko API. Free tier: 3 alerts.
